...
fig2_count_U937_sum <- ggplot(mod_U937_means, aes(x = mab, y = emmean_resp)) + 
        ...
        xlab("")+
        geom_segment(aes(x=c("Ig1"), xend=c("4C9"), y=1840, yend=1840))+
        geom_segment(aes(x=c("Ig1"), xend=c("4E4"), y=1900, yend=1900))+
        geom_segment(aes(x=c("Ig1"), xend=c("5H7"), y=1960, yend=1960))+
        geom_text(aes(x = "2C8", y = 1970, label = "***"), size = 7)+
        ylim(0, 2000)+
        ggtitle("U-937")
