...
files_cells <- list.files("E:/Лаборатория гибридомной технологии/результаты_эндоглин/R for monocyte adhesion/2018-10-11_co-culture_U937_TGF", pattern = "*.csv", full.names = F)
 ...
 class(table)
 table$date <- "2018-10-11"
 table$exp <- 2
 write.table(table, file="count_U937_TGF_exp2.csv", sep=";", row.names = F)
